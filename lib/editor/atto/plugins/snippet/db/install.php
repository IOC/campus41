...
function xmldb_atto_snippet_install() {
	...
	$forinstall = array('subsub-seccio','capsa-important','capsa-alerta','capsa-exemple-simple','capsa-exemple-cols','capsa-ampliacio','capsa-tasca','menu-pestanyes2','desplegable2','dues-columnes','youtube','vimeo','h5p');
	$templateindex=0;
