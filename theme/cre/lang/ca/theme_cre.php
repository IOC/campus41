...
$string['choosereadme'] = 'CRE is a child theme of Boost.';
// Name of the settings pages.
$string['configtitle'] = 'CRE settings';
...
$string['lestgo'] = 'Som-hi';

$string['backtomodule'] = 'Tornar al {$a}';

$string['quizreview'] = 'Revisió del qüestionari';